        ...
        <div className="w-full h-60 relative">
            ...
            >
                <svg
                    ...
                    className="fill-white size-10 stroke-none opacity-0 group-hover:opacity-100 transition-all duration-300"
...
const InstagramImages = () => {
    return (
        <section className="w-full grid grid-cols-1 md:grid-cols-5">
